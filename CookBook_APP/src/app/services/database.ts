...
// Define la forma de un registro de categoría leído desde la base de datos.
...
// Define la forma de un registro de ingrediente leído desde la base de datos.
...
// Define la forma de un registro de receta leído desde la base de datos.
export interface RecipeRecord {
  // Identificador único de la receta.
  id: number;
  // Nombre de la receta.
  name: string;
  // Subtítulo opcional de la receta para mostrar información breve.
  subtitle: string | null;
  // Descripción opcional resumida de la receta.
  description: string | null;
  // Instrucciones opcionales para preparar la receta.
  instructions: string | null;
  // Tiempo requerido en minutos (puede no estar definido).
  timeRequired: number | null;
}

// Define la estructura de datos necesaria para crear una receta nueva.
export interface CreateRecipeInput {
  // Nombre obligatorio de la receta.
  name: string;
  // Subtítulo opcional.
  subtitle?: string | null;
